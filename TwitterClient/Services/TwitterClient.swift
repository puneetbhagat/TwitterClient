...
class TwitterClient: BDBOAuth1RequestOperationManager {
    ...
    public static let shared = TwitterClient(baseURL: TWT_BASE_URL, consumerKey: TWT_CONSUMER_KEY, consumerSecret: TWT_CONSUMER_SECRET)
...
//            print("saved access token: \(token)")
    ...
    private override init!(baseURL: URL!, consumerKey: String!, consumerSecret: String!) {
        self.url = baseURL
    ...
    internal func toggle(favorite: Bool, tweetId: Int64, params: [String: Any]?, success: @escaping (_ tweet: Tweet?, _ error: Error?) -> Void) {
    ...
    internal func retweet(tweetId: Int64, toRetweet: Bool, params: [String: Any]?, success: @escaping (_ tweet: Tweet?, _ error: Error?) -> Void) {
